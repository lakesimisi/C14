...
import com.conhj.server.model.OrdersExample.Criteria;
import com.conhj.server.model.OrdersExample.Criterion;
...
public class OrdersSqlProvider {
    ...
    public String insertSelective(Orders record) {
        ...
        if (record.getOrderdate() != null) {
            sql.VALUES("orderdate", "#{orderdate,jdbcType=VARCHAR}");
        }
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        if (record.getOrderdate() != null) {
            sql.SET("orderdate = #{record.orderdate,jdbcType=VARCHAR}");
        }
    ...
    public String updateByPrimaryKeySelective(Orders record) {
        ...
        if (record.getOrderdate() != null) {
            sql.SET("orderdate = #{orderdate,jdbcType=VARCHAR}");
        }
